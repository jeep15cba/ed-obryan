...
import { Award, Users, Clock, ArrowRight, Shield, Target, Heart } from 'lucide-react'
  ...
  try {
    ...
    if (data) {
      ...
      aboutData = {
        ...
        description: "With over 15 years of dedicated experience, Mr Edward O'Bryan is a renowned orthopaedic surgeon specialising in hip and knee surgery, sports medicine, and advanced robotic joint replacement procedures.",
        specialties: [
          {
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 font-sans">
              {aboutData.title} 
              <span className="text-blue-600"> {aboutData.titleHighlight}</span>
            </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-gray-100 rounded-xl overflow-hidden relative" style={{ aspectRatio: '0.75' }}>
              {aboutData.professionalImage ? (
                (() => {
                  const imageProps = getResponsiveImageProps(
                    aboutData.professionalImage,
                    aboutData.professionalImage.alt || "Mr Edward O'Bryan - Professional Photo"
                  );
                ...
                <div className="h-full flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-sm">Mr O&apos;Bryan with patients</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200">
              ...
              <div className="space-y-1">
                <p className="text-sm font-medium text-gray-900">{aboutData.qualifications.primary}</p>
                <p className="text-sm text-gray-600">{aboutData.qualifications.secondary}</p>
                <p className="text-xs text-gray-500">{aboutData.qualifications.description}</p>
              </div>
            </div>
          </div>
        </div>
